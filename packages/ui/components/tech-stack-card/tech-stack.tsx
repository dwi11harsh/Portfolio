...
export const TechStack = () => {
  return (
    <div className="w-fit h-fit mr-auto ml-10 pr-20 bg-gray-50 relative group/card border border-black/[0.1]  rounded-xl p-6 dark:border-white/[0.2] hover:shadow-sm">
